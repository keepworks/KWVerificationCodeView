#
# Be sure to run `pod lib lint KWVerificationCodeView.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.author           = { 'Athul Sai' => 'athul@keepworks.com' }
  ...
  # s.resource_bundles = {
  #   'KWVerificationCodeView' => ['KWVerificationCodeView/Assets/*.png']
  # }
